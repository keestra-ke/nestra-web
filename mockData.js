  ...
  listings: [
    {
      ...
      totalRooms: 24,
      vacantRooms: 3,
      images: ['https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1545324418-cc1a9f4ef888?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600&h=400&fit=crop'],
      reviews: [
      ...
      distances: { 'Githurai Stage (matatu)': '0.3 km', 'Equity Bank': '0.6 km', 'Githurai Primary School': '0.4 km', 'Githurai Nursing Home': '1.2 km', 'Police Post Githurai 44': '0.8 km', 'Githurai Mosque': '0.5 km', 'PCEA Githurai Church': '0.2 km', 'Mama Pima Market': '0.3 km' }
    },
    { id: 'listing-002', name: 'Kimani Plaza', area: 'Githurai 45', floor: '2nd floor, Room 12', type: 'Single room', price: 3500, deposit: 3500, garbageFee: 150, caretaker: { name: 'John Waweru', phone: '0723 456 789' }, landlord: { name: 'Mrs. Grace Wanjiku', idNumber: 'KE23456789' }, water: { status: 'Rationed', schedule: '6am–10am and 5pm–8pm', storage: false }, electricity: { type: 'Token prepaid', meter: 'Shared per floor' }, wifi: { available: false }, security: 'Gate locks at 10pm, no guard', gps: { lat: -1.2213, lng: 36.9278 }, rating: 3.8, reviewCount: 14, verified: true, images: ['https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1493857671505-72967e2e2760?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=600&h=400&fit=crop'] },
    { id: 'listing-003', name: 'Mwangi Heights', area: 'Baba Dogo', floor: '4th floor, Room 3', type: 'One bedroom', price: 9000, deposit: 9000, garbageFee: 300, earlyDiscount: { amount: 200, payBeforeDay: 3 }, caretaker: { name: 'Peter Otieno', phone: '0734 567 890' }, landlord: { name: 'Mr. David Mwangi', idNumber: 'KE34567890' }, water: { status: 'Constant', storage: true }, electricity: { type: 'Postpaid', meter: 'Individual' }, wifi: { available: true, provider: 'Zuku' }, security: 'CCTV, gated, 24hr guard', gps: { lat: -1.2155, lng: 36.9301 }, rating: 4.7, reviewCount: 43, verified: true, images: ['https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1545324418-cc1a9f4ef888?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600&h=400&fit=crop'] },
    { id: 'listing-004', name: 'Nyota Court', area: 'Kasarani', floor: '1st floor, Room 5', type: 'Bedsitter', price: 6500, deposit: 13000, garbageFee: 250, caretaker: { name: 'Susan Chebet', phone: '0745 678 901' }, landlord: { name: 'Chebet Holdings Ltd', idNumber: 'KE45678901' }, water: { status: 'Constant', storage: true }, electricity: { type: 'Token prepaid', meter: 'Individual' }, wifi: { available: true, provider: 'Faiba' }, security: 'Gated compound', gps: { lat: -1.2089, lng: 36.9198 }, rating: 4.1, reviewCount: 19, verified: true, images: ['https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1493857671505-72967e2e2760?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1545324418-cc1a9f4ef888?w=600&h=400&fit=crop'] },
    { id: 'listing-005', name: 'Gitau Flats', area: 'Githurai 44', floor: '2nd floor, Room 9', type: 'Single room', price: 4000, deposit: 4000, garbageFee: 100, caretaker: { name: 'Mary Gitau', phone: '0756 789 012' }, landlord: { name: 'Joseph Gitau', idNumber: 'KE56789012' }, water: { status: 'Rationed', schedule: 'Off Tuesdays and Fridays' }, electricity: { type: 'Token prepaid', meter: 'Shared per 2 rooms' }, wifi: { available: false }, security: 'Gate only, no guard', gps: { lat: -1.2204, lng: 36.9262 }, rating: 3.5, reviewCount: 8, verified: false, images: ['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1493857671505-72967e2e2760?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=400&fit=crop'] },
    { id: 'listing-006', name: 'Green Valley Apartments', area: 'Roysambu', floor: '3rd floor, Room 14', type: 'Two bedroom', price: 14000, deposit: 14000, garbageFee: 400, earlyDiscount: { amount: 500, payBeforeDay: 5 }, caretaker: { name: 'Agnes Muthoni', phone: '0767 890 123' }, landlord: { name: 'Green Valley Properties', idNumber: 'KE67890123' }, water: { status: 'Constant', storage: true, source: 'borehole' }, electricity: { type: 'Postpaid', meter: 'Individual' }, wifi: { available: true, provider: 'Safaricom Home' }, security: 'Electric fence, CCTV, 24hr guard', gps: { lat: -1.2071, lng: 36.9154 }, rating: 4.9, reviewCount: 67, verified: true, images: ['https://images.unsplash.com/photo-1545324418-cc1a9f4ef888?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=600&h=400&fit=crop', 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=400&fit=crop'] }
  ],
